    ...
    <main style={{ padding: "32px", fontFamily: "Arial, sans-serif" }}>
      <div style={{ maxWidth: "900px", margin: "0 auto" }}>
        ...
        <div style={{ marginTop: "24px" }}>
          <p style={{ color: "#777", marginBottom: "8px" }}>Operational Excellence</p>
          ...
          <p style={{ color: "#555", lineHeight: 1.7, maxWidth: "720px" }}>
            OEE monitoring tool for production performance, availability, quality, downtime, shift reporting, and improvement tracking.
          </p>
