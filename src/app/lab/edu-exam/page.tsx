    ...
    <main style={{ padding: "32px", fontFamily: "Arial, sans-serif" }}>
      <div style={{ maxWidth: "900px", margin: "0 auto" }}>
        ...
        <div style={{ marginTop: "24px" }}>
          <p style={{ color: "#777", marginBottom: "8px" }}>Education</p>
          ...
          <p style={{ color: "#555", lineHeight: 1.7, maxWidth: "720px" }}>
            Question bank tool to collect school exercises, exam questions, correct answers, review notes, and learning history.
          </p>
