    ...
    <main style={{ padding: "32px", fontFamily: "Arial, sans-serif" }}>
      <div style={{ maxWidth: "900px", margin: "0 auto" }}>
        ...
        <div style={{ marginTop: "24px" }}>
          <p style={{ color: "#777", marginBottom: "8px" }}>HSE Operations</p>
          ...
          <p style={{ color: "#555", lineHeight: 1.7, maxWidth: "720px" }}>
            Digital permit-to-work concept for high-risk jobs, approval workflow, worker list, hazard checklist, job evidence, and permit closure.
          </p>
