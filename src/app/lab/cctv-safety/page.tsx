    ...
    <main style={{ padding: "32px", fontFamily: "Arial, sans-serif" }}>
      <div style={{ maxWidth: "900px", margin: "0 auto" }}>
        ...
        <div style={{ marginTop: "24px" }}>
          <p style={{ color: "#777", marginBottom: "8px" }}>Safety Technology</p>

          <h1 style={{ fontSize: "34px", margin: "0 0 12px" }}>
            CCTV Safety Observation
          </h1>
          ...
          <p style={{ color: "#555", lineHeight: 1.7, maxWidth: "720px" }}>
            Safety observation dashboard concept using CCTV, unsafe action records, worker identification, corrective actions, and safety trend monitoring.
          </p>
