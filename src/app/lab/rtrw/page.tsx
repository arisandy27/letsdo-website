    ...
    <main style={{ padding: "32px", fontFamily: "Arial, sans-serif" }}>
      <div style={{ maxWidth: "900px", margin: "0 auto" }}>
        ...
        <div style={{ marginTop: "24px" }}>
          <p style={{ color: "#777", marginBottom: "8px" }}>Community Administration</p>
          ...
          <p style={{ color: "#555", lineHeight: 1.7, maxWidth: "720px" }}>
            Resident administration tool for family data, letters, dues, events, complaints, and local community reporting.
          </p>
